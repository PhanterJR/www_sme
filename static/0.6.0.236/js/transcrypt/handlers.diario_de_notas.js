// Transcrypt'ed from Python, 2022-01-19 13:42:56
...
export var Diario =  __class__ ('Diario', [object], {
	...
	get processar_diario () {return __get__ (this, function (self, diario_de_notas) {
		...
		var html = DIV (H2 ('Diário de notas ', STRONG (diario_de_notas.turma.turma), __kwargtrans__ ({_class: 'media-print-visible'})), __kwargtrans__ ({_class: 'diario_de_notas_container diario_de_notas_imprimir phanterpwa-simple-media-print'}));
