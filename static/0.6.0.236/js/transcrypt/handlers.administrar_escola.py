...
__pragma__("skip")
jQuery = window = console = WebSocket = __new__ = location = this = confirm = localStorage = js_undefined = 0
__pragma__("noskip")
...
class Index(gatehandler.Handler):
                    ...
                    DIV(
                        DIV(
                            DIV(
                                ...
                                DIV("Documentos de interesse público referentes a educação do município de Fátima.", _class='promo-content'),
                                **{
                        ...
                        DIV(
                            DIV(
                                ...
                                DIV("Conheça nossa rede municipal. Aqui também é possível o acesso dos serviços online de cada núcleo Escolar.", _class='promo-content'),
                                **{
                                    "_class": "promo-container",
                                }
                            ),
                        ...
                        DIV(
                            DIV(
                                ...
                                DIV("Fique informado sobre tudo que se passa em nossa rede escolar.", _class='promo-content'),
                                **{
                                    "_class": "promo-container",
                                }
                            ),
    ...
    def _after_load(self, data):
        xml = jQuery("#phanterpwa-snippet-phanterpwa-logo-wrapper")
