// Transcrypt'ed from Python, 2021-08-18 23:48:39
...
export var Series =  __class__ ('Series', [helpers.XmlConstructor], {
	...
	get escolha_de_series_xml () {return __get__ (this, function (self, json) {
		...
		var logo = '{0}/api/escolas/{1}/image'.format (window.PhanterPWA.ApiServer.remote_address, self.id_escola);
		var titulo = H2 ('ESCOLHA AS SÉRIES/ANOS QUE SÃO OFERTADAS PELA SUA UNIDADE ESCOLHAR', ' NO ANO LETIVO DE ', STRONG (self.ano_letivo));
	...
	get _get_series () {return __get__ (this, function (self) {
		...
		window.PhanterPWA.ApiServer.GET ('api', 'series', self.id_escola, self.ano_letivo, __kwargtrans__ ({onComplete: self.after_get}));
	});},
