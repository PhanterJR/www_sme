// Transcrypt'ed from Python, 2021-04-07 02:50:28
...
export var Error_401 =  __class__ ('Error_401', [gatehandler.ErrorHandler], {
	__module__: __name__,
	get initialize () {return __get__ (this, function (self) {
		var html = CONCATENATE (DIV (DIV (DIV (DIV (I18N ('Authentication required', __kwargtrans__ (dict ({'_pt-br': 'Necessário Autenticar-se'}))), __kwargtrans__ ({_class: 'phanterpwa-breadcrumb'})), __kwargtrans__ ({_class: 'phanterpwa-breadcrumb-wrapper'})), __kwargtrans__ ({_class: 'phanterpwa-container container'})), __kwargtrans__ ({_class: 'title_page_container card'})), DIV (DIV (DIV (DIV (DIV (IMG (__kwargtrans__ ({_class: 'image-warnings', _src: '/static/{0}/images/warning.png'.format (window.PhanterPWA.VERSIONING)}))), __kwargtrans__ ({_class: 'image-warnings-container'})), DIV (I18N ('You need authentication to access this feature.', __kwargtrans__ (dict ({'_pt-br': 'Você precisa autenticar-se para tentar acessar este recurso.'}))), __kwargtrans__ ({_id: 'content-warning', _class: 'content-warnings'})), DIV (DIV (I18N ('Login'), __kwargtrans__ ({_id: 'alternative_login_button', _class: 'btn wave_on_click link'})), __kwargtrans__ ({_class: 'button-container'})), __kwargtrans__ ({_class: 'warnings-container card phanterpwa-card-container'})), __kwargtrans__ ({_class: 'new-container'})), __kwargtrans__ ({_class: 'phanterpwa-container container'})));
...
//# sourceMappingURL=handlers.errors.map