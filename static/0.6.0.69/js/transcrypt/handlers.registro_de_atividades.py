...
class RegistroDeAtividades():
    ...
    def processar_controle_de_atividades(self, controle_de_atividades):
        ...
        if self.eh_educacao_infantil:
            ...
            tabela = TABLE(
                TR(TH("Nº", _class="rotulo", _rowspan=2), TH("NOME ALUNO(A)", _class="rotulo", _rowspan=2), TH("DISCIPLINAS", _class="rotulo", _rowspan=2), TH("DIAS LETIVOS", _colspan=self.quant_dias, _class="rotulo")),
                _class='tabela_controle_de_atividades'
            )
