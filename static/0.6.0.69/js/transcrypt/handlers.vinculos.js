// Transcrypt'ed from Python, 2021-08-28 06:57:43
...
export var Vinculo =  __class__ ('Vinculo', [helpers.XmlConstructor], {
	...
	get get_form_vinculo () {return __get__ (this, function (self) {
		...
		if (self.arg0 == 'novo' && str (self.arg1).isdigit () && str (self.arg2).isdigit () && str (self.arg3).isdigit ()) {
			window.PhanterPWA.ApiServer.GET (__kwargtrans__ (dict ({'url_args': ['api', 'vinculo', self.arg0, self.arg1, self.arg2, self.arg3], 'onComplete': self.after_get, 'get_cache': self.process_data})));
		}
		else {
