// Transcrypt'ed from Python, 2021-10-22 20:11:07
...
export var CheckBox =  __class__ ('CheckBox', [Widget], {
	...
	get set_disabled () {return __get__ (this, function (self) {
		...
		self._disabled = true;
		var target = $ (self.target_selector).find ('.phanterpwa-widget-wrapper').addClass ('disabled');
	});},
	get set_enabled () {return __get__ (this, function (self) {
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
		...
		var target = $ (self.target_selector).find ('.phanterpwa-widget-wrapper').removeClass ('disabled');
	});},
...
export var MenuBox =  __class__ ('MenuBox', [Widget], {
	...
	get __init__ () {return __get__ (this, function (self, identifier, button) {
		...
		if (button === undefined || button === null) {
			...
			if (isinstance (button, helpers.XmlConstructor) && button.tag == 'i') {
				var class_button = ' icon_button';
			}
			self._button = button;
		}
