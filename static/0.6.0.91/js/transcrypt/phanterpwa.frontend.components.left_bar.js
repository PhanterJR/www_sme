// Transcrypt'ed from Python, 2021-09-21 12:37:19
...
export var LeftBarUserMenu =  __class__ ('LeftBarUserMenu', [helpers.XmlConstructor], {
	...
	get __init__ () {return __get__ (this, function (self) {
		...
		self._show_if = parameters.py_get ('show_if', true);
		self._show_if_way_match = parameters.py_get ('show_if_way_match', null);
		self._image = IMG (__kwargtrans__ ({_id: 'phanterpwa-component-left_bar-url-imagem-user', _src: '/static/{0}/images/user.png'.format (window.PhanterPWA.VERSIONING), _alt: 'user avatar'}));
