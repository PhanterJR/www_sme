...
class QuestionarioSocial():
    ...
    def __init__(self):
        ...
        if self.arg4 == "editar":
            ...
            html.html_to("#main-container")
            self.social = alunos.Social(self, self.id_aluno, "#formulario_editar_aluno", lambda: self.process_data_social())
        else:
            html = CONCATENATE(
                DIV(
                    DIV(
    ...
    def process_data_social(self):
        window.PhanterPWA.open_xway(
            ...
            self.ano_letivo,
            self.id_aluno,
            **{"_{0}".format(x): window.PhanterPWA.Request.params[x] for x in dict(window.PhanterPWA.Request.params).keys()}
        )
            ...
            array_botoes.append(
                widgets.FloatButton(
                    I(
                        DIV(
                            DIV(
                                SPAN(I(_class="fas fa-file-alt"), _class="icombine-container-first"),
...
class Turma():
    ...
    def abrir_modal_escolher_campos(self):
        ...
        wg = widgets.ListString(
            "lista_de_campos_permitidos",
            label="Campos disponíveis",
            placeholder="Escolha o campo disponível.",
...
class Vinculos():
    ...
    def __init__(self):
        ...
        self._fields_names = {
            "nome_completo": "Nome do(a) Funcionário(a)",
