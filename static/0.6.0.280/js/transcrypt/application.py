...
import handlers.matricular as matricular
...
import handlers.indicadores_de_desempenho as indicadores_de_desempenho
...
gates = {
    ...
    'indicadores-de-desempenho': indicadores_de_desempenho.Index,
    'escolas': escolas.Index,
    'escola-configuracao': escolas.Configuracoes,
    'alunos': alunos.Index,
    'matricula': matricula.Index,
    'matricular': matricular.Index,
    ...
    'registro-de-aulas-educacao-infantil': registro_de_aulas_educacao_infantil.Index,
