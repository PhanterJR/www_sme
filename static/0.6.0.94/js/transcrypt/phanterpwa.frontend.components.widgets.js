// Transcrypt'ed from Python, 2021-10-27 01:57:51
...
export var Autocomplete =  __class__ ('Autocomplete', [Widget], {
	...
	get __init__ () {return __get__ (this, function (self, identifier) {
		...
		var select = SELECT (__kwargtrans__ ({_class: 'phanterpwa-widget-autocomplete-select', _name: self._name}));
		var table = TABLE (__kwargtrans__ ({_class: 'phanterpwa-widget-autocomplete-options-wrapper'}));
		self._xml_modal = table;
		self._xml_select = select;
		self._create_xml_select ();
		self._create_xml_modal ();
		var html = DIV (INPUT (__kwargtrans__ (dict ({'_id': 'phanterpwa-widget-autocomplete-input-{0}'.format (identifier), '_value': self._alias_value, '_placeholder': self._placeholder, '_disabled': 'disabled', '_data-validators': JSON.stringify (self._validator), '_data-form': self._form, '_name': self._name}))), label, DIV (I (__kwargtrans__ ({_class: 'fab fa-sistrix'})), __kwargtrans__ ({_class: 'phanterpwa-widget-autocomplete-caret'})), xml_icon, DIV (I (__kwargtrans__ ({_class: 'fas fa-check'})), __kwargtrans__ ({_class: 'phanterpwa-widget-check'})), DIV (__kwargtrans__ ({_class: 'phanterpwa-widget-autocomplete-touchpad', _tabindex: '0'})), self._xml_select, DIV (self.get_message_error (), __kwargtrans__ ({_class: 'phanterpwa-widget-message_error phanterpwa-widget-autocomplete-message_error'})), __kwargtrans__ (wrapper_attr));
		Widget.__init__ (self, identifier, html, __kwargtrans__ (parameters));
	});},
	get set_recalc_on_scroll () {return __get__ (this, function (self, value) {
		if (arguments.length) {
	...
	get _create_xml_select () {return __get__ (this, function (self) {
		...
		var has_default = false;
		var select = SELECT (__kwargtrans__ (dict ({'_class': 'phanterpwa-widget-autocomplete-select', '_name': self._name})));
		if (self._data !== []) {
			for (var vdata of self._data) {
				if (self._value !== '') {
					if (vdata [0] == self._value) {
	...
	get _create_xml_modal () {return __get__ (this, function (self) {
		...
		if (self._data !== []) {
			if (self._can_empty) {
				if (self._value === '') {
					var icon_empty = DIV (self._icon_option_selected, __kwargtrans__ ({_class: 'phanterpwa-widget-autocomplete-li-icon'}));
				}
				else {
					var icon_empty = DIV (self._icon_option, __kwargtrans__ ({_class: 'phanterpwa-widget-autocomplete-li-icon'}));
				}
				table.append (TR (TD (SPAN (I18N ('Empty')), icon_empty, __kwargtrans__ (dict ({'_data-value': '', '_data-target': 'phanterpwa-widget-autocomplete-input-{0}'.format (self.identifier), '_data-text': '', '_tabindex': '0', '_class': 'phanterpwa-widget-autocomplete-li-option empty'})))));
			}
			for (var vdata of self._data) {
				if (self._value !== '') {
					if (vdata [0] == self._value) {
						table.append (TR (TD (SPAN (vdata [1]), DIV (self._icon_option_selected, __kwargtrans__ ({_class: 'phanterpwa-widget-autocomplete-li-icon'})), __kwargtrans__ (dict ({'_data-value': vdata [0], '_data-text': vdata [1], '_data-target': 'phanterpwa-widget-autocomplete-input-{0}'.format (self.identifier), '_tabindex': '0', '_class': 'phanterpwa-widget-autocomplete-li-option selected'})))));
					}
					else {
						table.append (TR (TD (SPAN (vdata [1]), DIV (self._icon_option, __kwargtrans__ ({_class: 'phanterpwa-widget-autocomplete-li-icon'})), __kwargtrans__ (dict ({'_data-value': vdata [0], '_data-text': vdata [1], '_data-target': 'phanterpwa-widget-autocomplete-input-{0}'.format (self.identifier), '_tabindex': '0', '_class': 'phanterpwa-widget-autocomplete-li-option'})))));
					}
				}
				else {
					table.append (TR (TD (SPAN (vdata [1]), DIV (self._icon_option, __kwargtrans__ ({_class: 'phanterpwa-widget-autocomplete-li-icon'})), __kwargtrans__ (dict ({'_data-value': vdata [0], '_data-text': vdata [1], '_data-target': 'phanterpwa-widget-autocomplete-input-{0}'.format (self.identifier), '_tabindex': '0', '_class': 'phanterpwa-widget-autocomplete-li-option'})))));
			...
			var icon_placeholder = DIV (DIV (DIV (self._icon_plus, __kwargtrans__ ({_class: 'link phanterpwa-widget-autocomplete-li-icon_plus'})), DIV (INPUT (__kwargtrans__ ({_class: 'phanterpwa-widget-autocomplete-li-input'})), DIV (self._icon_confirm, __kwargtrans__ ({_class: 'phanterpwa-widget-autocomplete-li-icon_confirm link'})), __kwargtrans__ ({_class: 'phanterpwa-widget-autocomplete-li-input-editable'})), __kwargtrans__ ({_class: 'phanterpwa-widget-autocomplete-li-input-editable-wrapper'})), __kwargtrans__ ({_class: 'phanterpwa-widget-autocomplete-li-icon_plus-wrapper'}));
			if (self._placeholder !== null) {
				if (self._editable) {
					table.insert (0, TR (TD (SPAN (self._placeholder, __kwargtrans__ ({_class: 'phanterpwa-widget-autocomplete-placeholder'})), icon_placeholder, __kwargtrans__ (dict ({'_data-value': '', '_data-target': 'phanterpwa-widget-autocomplete-input-{0}'.format (self.identifier), '_data-text': '', '_tabindex': '0', '_class': 'phanterpwa-widget-autocomplete-li-title has_editable'})))));
				}
				else {
					table.insert (0, TR (TD (SPAN (self._placeholder, __kwargtrans__ ({_class: 'phanterpwa-widget-autocomplete-placeholder'})), '', __kwargtrans__ (dict ({'_data-value': '', '_data-target': 'phanterpwa-widget-autocomplete-input-{0}'.format (self.identifier), '_data-text': '', '_tabindex': '0', '_class': 'phanterpwa-widget-autocomplete-li-title'})))));
				}
			}
			else if (self._editable) {
				table.insert (0, TR (TD (SPAN (self._placeholder, __kwargtrans__ ({_class: 'phanterpwa-widget-autocomplete-placeholder'})), icon_placeholder, __kwargtrans__ (dict ({'_data-value': '', '_data-target': 'phanterpwa-widget-autocomplete-input-{0}'.format (self.identifier), '_data-text': '', '_tabindex': '0', '_class': 'phanterpwa-widget-autocomplete-li-title has_editable'})))));
	...
	get _switch_focus () {return __get__ (this, function (self, el) {
		...
		if (p.hasClass ('focus')) {
			...
			$ ('.phanterpwa-widget-autocomplete-wrapper').removeClass ('focus').removeClass ('pre_focus');
			p.addClass ('focus');
			setTimeout ((function __lambda__ () {
				if (arguments.length) {
					var __ilastarg0__ = arguments.length - 1;
	...
	get _binds () {return __get__ (this, function (self) {
		...
		var target = $ (self.target_selector);
		self._add_div_animation (target);
		target.find ('.phanterpwa-widget-autocomplete-touchpad').off ('click.phanterpwa-event-input_materialize').on ('click.phanterpwa-event-input_materialize', (function __lambda__ () {
			if (arguments.length) {
				var __ilastarg0__ = arguments.length - 1;
				if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
					var __allkwargs0__ = arguments [__ilastarg0__--];
		...
		target.find ('.phanterpwa-widget-autocomplete-touchpad').off ('focus.phanterpwa-event-input_materialize').on ('focus.phanterpwa-event-input_materialize', (function __lambda__ () {
			if (arguments.length) {
				var __ilastarg0__ = arguments.length - 1;
				if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
					var __allkwargs0__ = arguments [__ilastarg0__--];
		...
		target.find ('.phanterpwa-widget-autocomplete-touchpad').off ('focusout.phanterpwa-event-input_materialize').on ('focusout.phanterpwa-event-input_materialize', (function __lambda__ () {
			if (arguments.length) {
				var __ilastarg0__ = arguments.length - 1;
				if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
					var __allkwargs0__ = arguments [__ilastarg0__--];
		...
		target.find ('label').off ('click.phanterpwa-event-input_materialize').on ('click.phanterpwa-event-input_materialize', (function __lambda__ () {
			...
			return target.find ('.phanterpwa-widget-autocomplete-touchpad').trigger ('click');
		}));
		target.find ('.phanterpwa-widget-autocomplete-touchpad').off ('keydown.open_by_key').on ('keydown.open_by_key', (function __lambda__ (event) {
			if (arguments.length) {
				var __ilastarg0__ = arguments.length - 1;
				if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
					var __allkwargs0__ = arguments [__ilastarg0__--];
	...
	get _on_modal_keypress () {return __get__ (this, function (self, event) {
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
			if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
				var __allkwargs0__ = arguments [__ilastarg0__--];
	...
	get _binds_modal_content () {return __get__ (this, function (self) {
		...
		$ ($ ('.phanterpwa-component-pseudomodal-content').find ('.phanterpwa-widget-autocomplete-li-option') [0]).focus ();
	});},
	get start () {return __get__ (this, function (self) {
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
...
export var FloatMenu =  __class__ ('FloatMenu', [Widget], {
	...
	get __init__ () {return __get__ (this, function (self, identifier, button) {
		...
		var html = DIV (self._button, DIV (__kwargtrans__ ({_class: 'phanterpwa-widget-floatmenu-options-content'})), __kwargtrans__ ({_class: 'phanterpwa-widget-floatmenu-button{0}'.format (class_button), _phanterpwa_dowpdown_target: 'drop_{0}'.format (identifier)}));
		if (__in__ ('_class', parameters)) {
	...
	get _on_click () {return __get__ (this, function (self, el) {
		...
		var element = $ (el).find ('.phanterpwa-widget-floatmenu-options-content');
