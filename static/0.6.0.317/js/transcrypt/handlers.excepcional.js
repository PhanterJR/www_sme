// Transcrypt'ed from Python, 2022-01-19 13:42:57
...
export var Index =  __class__ ('Index', [gatehandler.Handler], {
	...
	get submit_nome_e_cpf () {return __get__ (this, function (self, el) {
		...
		$ ('#form-funcionarios').find ('.phanterpwa-widget-wrapper').removeClass ('has_error');
		...
		if (ajax_status == 'success') {
			...
			if (data.responseJSON.errors !== undefined) {
				...
				for (var x of errors.py_keys ()) {
					var target = $ ('#phanterpwa-widget-funcionarios-{0}'.format (x));
