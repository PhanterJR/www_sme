...
export var ApiServer =  __class__ ('ApiServer', [object], {
	...
	get GET () {return __get__ (this, function (self) {
		...
		var ajax_param = dict ([['url', url], ['type', 'GET'], ['complete', (function __lambda__ (a, b, c) {
			if (arguments.length) {
				var __ilastarg0__ = arguments.length - 1;
				if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
					var __allkwargs0__ = arguments [__ilastarg0__--];
	...
	get DELETE () {return __get__ (this, function (self) {
		...
		var ajax_param = dict ([['url', url], ['type', 'DELETE'], ['complete', (function __lambda__ (a, b, c) {
			if (arguments.length) {
				var __ilastarg0__ = arguments.length - 1;
				if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
					var __allkwargs0__ = arguments [__ilastarg0__--];
	...
	get POST () {return __get__ (this, function (self) {
		...
		var ajax_param = dict ([['url', url], ['type', 'POST'], ['data', form_data], ['complete', (function __lambda__ (a, b, c) {
			if (arguments.length) {
				var __ilastarg0__ = arguments.length - 1;
				if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
					var __allkwargs0__ = arguments [__ilastarg0__--];
	...
	get PUT () {return __get__ (this, function (self) {
		...
		var ajax_param = dict ([['url', url], ['type', 'PUT'], ['data', form_data], ['complete', (function __lambda__ (a, b, c) {
			if (arguments.length) {
				var __ilastarg0__ = arguments.length - 1;
				if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
					var __allkwargs0__ = arguments [__ilastarg0__--];
