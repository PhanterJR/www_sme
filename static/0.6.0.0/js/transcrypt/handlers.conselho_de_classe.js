...
export var ConselhoDeClasse =  __class__ ('ConselhoDeClasse', [object], {
	...
	get processar_conselho () {return __get__ (this, function (self) {
		...
		if (self.unidade == 0) {
			...
			var tabela = TABLE (TR (TH ('ALUNO(A)'), TH ('DISCIPLINA'), TH ('MÉDIA'), TH ('RECUPERAÇÃO')), __kwargtrans__ ({_class: 'tabela_conselho_de_classe', _style: 'margin: auto; width: 200mm;'}));
			...
			var html_tabela2 = '';
			if (has_tabela2) {
				var html_tabela2 = CONCATENATE (H3 ('LISTA DE ALUNOS E DISCIPLINAS A QUAL VÃO PARA O CONSELHO FINAL'), tabela2);
			}
			var html_tabela3 = '';
			if (has_tabela3) {
				var html_tabela3 = CONCATENATE (H3 ('LISTA DE DISCIPLINAS E ALUNOS A QUAL VÃO PARA O CONSELHO FINAL'), tabela3);
			}
