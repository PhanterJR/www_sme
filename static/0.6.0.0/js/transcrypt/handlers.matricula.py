...
class Matricula(helpers.XmlConstructor):
    ...
    def xml_editar_aluno(self):
        ...
        if arg3 == "editar" and str(arg4).isdigit():
                        ...
                        DIV(
                            DIV(
                                DIV(
                                    ...
                                    DIV(
                                        P("CONFIRA ESTAS INFORMAÇÕES DO QUESTIONÁRIO SOCIAL, COM ELE PODEMOS CONHECER MELHOR O ALUNO AJUDANDO NA AÇÕES DE POLÍTICAS PÚBLICAS, COMO TRANSPORTE, SAÚDE, INTEGRAÇÃO ESCOLAR, ETC."),
            ...
            self.alunos = alunos.Social(self, self.arg0, "#formulario_editar_aluno", lambda: self.process_data_social())
        else:
            html = DIV(
                DIV(
                    DIV(
            ...
            html.html_to("#content-matricula")
            self.alunos = alunos.Aluno(self, self.arg0, "editar", "#formulario_editar_aluno", lambda: self.process_data_aluno())
    ...
    def process_data_social(self, data):
        arg0 = window.PhanterPWA.Request.get_arg(0)
        arg1 = window.PhanterPWA.Request.get_arg(1)
        arg2 = window.PhanterPWA.Request.get_arg(2)
        window.PhanterPWA.open_xway("matricula", arg0, arg1, arg2, "conferido")

    def process_data_aluno(self, data):
        arg0 = window.PhanterPWA.Request.get_arg(0)
        arg1 = window.PhanterPWA.Request.get_arg(1)
        arg2 = window.PhanterPWA.Request.get_arg(2)
