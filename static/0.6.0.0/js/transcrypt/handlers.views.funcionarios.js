		...
		if (self.current_hash !== json.hash) {
			...
			if (funcionarios.data !== undefined) {
				for (var x of funcionarios.data) {
					...
					var vars_funcionario = dict ([['funcionario', x.funcionario], ['data_de_nascimento', data_de_nascimento_formated], ['nome_do_pai', x.nome_do_pai], ['nome_da_mae', x.nome_da_mae]]);
