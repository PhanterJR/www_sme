// Transcrypt'ed from Python, 2022-03-14 09:15:07
...
export var Modal =  __class__ ('Modal', [object], {
	...
	get __init__ () {return __get__ (this, function (self, target_selector) {
		...
		if (__in__ ('_class', parameters)) {
			parameters ['_class'] = '{0}{1}{2}'.format (parameters ['_class'].strip (), ' phanterpwa-component-modal-wrapper phanterpwa-container', _class_panel);
		}
		else {
