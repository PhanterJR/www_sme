// Transcrypt'ed from Python, 2022-03-14 09:15:12
...
export var I18NServer =  __class__ ('I18NServer', [object], {
	...
	get get_user_lang () {return function () {
		...
		var storage = I18NServer.load_storage ();
		if (__in__ ('default_lang', storage) && storage ['default_lang'] !== null) {
	...
	get _get_translations_on_server () {return __get__ (this, function (self, new_word) {
		...
		if (window.PhanterPWA !== undefined) {
			if (window.PhanterPWA.DEBUG && self.userLang !== null) {
	...
	get get_translations () {return __get__ (this, function (self) {
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
			if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
				var __allkwargs0__ = arguments [__ilastarg0__--];
		...
		if (window.PhanterPWA !== undefined && self.userLang !== null) {
			window.PhanterPWA.ApiServer.GET (__kwargtrans__ (dict ({'url_args': ['api', 'i18n', window.PhanterPWA.get_app_name ()], 'url_vars': dict ({'lang': self.userLang}), 'onComplete': self.after_get_translations})));
		}
	});},
	...
	get DOMTranslate () {return __get__ (this, function (self, target) {
		...
		var eachTitleElement = function (el) {
			if (arguments.length) {
				var __ilastarg0__ = arguments.length - 1;
				if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
					var __allkwargs0__ = arguments [__ilastarg0__--];
			...
			var t_elem = $ (el);
			var word = t_elem.attr ('phanterpwa-i18n-title');
			if (word !== null && word !== undefined) {
				if (t_elem [0].hasAttribute (self.userLang)) {
		...
		if (self.target [0] !== undefined) {
			...
			self.target.find ('[phanterpwa-i18n-title]').each ((function __lambda__ () {
				if (arguments.length) {
					var __ilastarg0__ = arguments.length - 1;
					if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
						var __allkwargs0__ = arguments [__ilastarg0__--];
