// Transcrypt'ed from Python, 2022-01-20 23:25:53
...
export var IndicadoresDeDesempenho =  __class__ ('IndicadoresDeDesempenho', [object], {
	...
	get processar_turmas () {return __get__ (this, function (self) {
		...
		var tr_inicial_multi = TBODY (TR (TH ('TURMA'), TH ('SÉRIE'), TH ('MAT. INICIAL'), TH ('ADM'), TH ('TRANS'), TH ('APRO'), TH ('REP'), TH ('ABAN'), TH ('BASE. CALC'), TH ('APRO %'), TH ('REP %'), TH ('ABAN %'), TH ('TOT. FINAL'), __kwargtrans__ ({_class: 'rotulo_indicador'})), __kwargtrans__ ({_class: 'tbody-indicador-container'}));
		var tr_inicial_multi_por_disciplina = TBODY (TR (TH ('SÉRIE'), TH ('MAT. INICIAL'), TH ('ADM'), TH ('TRANS'), TH ('APRO'), TH ('REP'), TH ('ABAN'), TH ('BASE. CALC'), TH ('APRO %'), TH ('REP %'), TH ('ABAN %'), TH ('TOT. FINAL'), __kwargtrans__ ({_class: 'rotulo_indicador'})), __kwargtrans__ ({_class: 'tbody-indicador-container'}));
		...
		self.html_indicador_multi_por_disciplina_uni1 = DIV (H3 ('Indicadores de Desempenho - Multisseriado por Série - Unidade I'), self.html_tabela_multi_por_disciplina_uni1, __kwargtrans__ ({_class: 'indicador_desempenho_container indicador_desempenho_container_mult_uni1'}));
		self.html_indicador_multi_por_disciplina_uni2 = DIV (H3 ('Indicadores de Desempenho - Multisseriado por Série - Unidade II'), self.html_tabela_multi_por_disciplina_uni2, __kwargtrans__ ({_class: 'indicador_desempenho_container indicador_desempenho_container_mult_uni2'}));
		self.html_indicador_multi_por_disciplina_uni3 = DIV (H3 ('Indicadores de Desempenho - Multisseriado por Série - Unidade III'), self.html_tabela_multi_por_disciplina_uni3, __kwargtrans__ ({_class: 'indicador_desempenho_container indicador_desempenho_container_mult_uni3'}));
		self.html_indicador_multi_por_disciplina_uni4 = DIV (H3 ('Indicadores de Desempenho - Multisseriado por Série - Unidade IV'), self.html_tabela_multi_por_disciplina_uni4, __kwargtrans__ ({_class: 'indicador_desempenho_container indicador_desempenho_container_mult_uni4'}));
		self.html_indicador_multi_por_disciplina_unif = DIV (H3 ('Indicadores de Desempenho - Multisseriado por Série - Final'), self.html_tabela_multi_por_disciplina_unif, __kwargtrans__ ({_class: 'indicador_desempenho_container indicador_desempenho_container_mult_unif'}));
			...
			if (json.multisseriado) {
				...
				for (var x of json.indicadores) {
					...
					if (self.unidades == 4) {
						...
						var total_base = self.total_final_4 + self.total_desistentes_4;
