// Transcrypt'ed from Python, 2021-11-21 18:45:04
...
export var RegistroDeAtividades =  __class__ ('RegistroDeAtividades', [gatehandler.Handler], {
	...
	get processar_turmas () {return __get__ (this, function (self) {
		...
		var tr_inicial = TBODY (TR (TH ('TURMA'), TH ('QUANT. ALUNOS'), TH ('TURNO'), TH ('FEZ (%)', __kwargtrans__ ({_class: 'centralizado'})), TH ('FEZ PARCIALMENTE (%)', __kwargtrans__ ({_class: 'centralizado'})), TH ('NÃO FEZ (%)', __kwargtrans__ ({_class: 'centralizado'})), TH ('TOTAL (100%)', __kwargtrans__ ({_class: 'centralizado'})), TH ('QUANT. ALUNOS NÃO ENTREGARAM'), __kwargtrans__ ({_class: 'rotulo_estat_registro_de_atividades phanterpwa-widget-table-head phanterpwa-widget'})), __kwargtrans__ ({_class: 'tbody-estat_registro_de_atividades-container'}));
