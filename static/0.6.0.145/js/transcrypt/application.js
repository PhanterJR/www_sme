...
export var gates = dict ({'home': home.Index, 'admin': admin.Administration, 'profile': auth_user.Profile, 'artigos': artigos.Index, 'oauth': auth_user.Oauth, 'two_factor': auth_user.TwoFactor, 'lock': auth_user.Lock, 'administrar-escola': administrar_escola.Index, 'estatistica-controle-de-atividades': estatisticas.ControleDeAtividades, 'estatistica-registro-de-atividades': estatisticas.RegistroDeAtividades, 'pais-e-alunos': pais_e_alunos.Index, 'area-do-servidor': servidores.Index, 'identificar-servidor': identificar_servidor.Index, 'indicadores-de-desempenho': indicadores_de_desempenho.Index, 'escolas': escolas.Index, 'alunos': alunos.Index, 'matricula': matricula.Index, 'matriculas': matriculas.Index, 'vinculos': vinculos.Index, 'funcionarios': funcionarios.Index, 'professores': professores.Index, 'series': series.Index, 'disciplinas': disciplinas.Index, 'turmas': turmas.Index, 'imprimir': imprimir.Index, 'diario-de-notas': diario_de_notas.Index, 'calendarios': calendarios.Index, 'ficha-avaliativa': ficha_avaliativa.Index, 'registro-de-aulas': registro_de_aulas.Index, 'diario-integrado': diario_integrado.Index, 'conselho-de-classe': conselho_de_classe.Index, 'boletins': boletins.Index, 'registro-de-faltas': registro_de_faltas.Index, 'controle-de-atividades': controle_de_atividades.Index, 'registro-de-atividades': registro_de_atividades.Index, 'excepcional': excepcional.Index, 'root-commands': rootcmd.Commands});
