...
export var Visualizar =  __class__ ('Visualizar', [helpers.XmlConstructor], {
	...
	get __init__ () {return __get__ (this, function (self, id_matricula, id_escola, ano_letivo, prof_pai, prof_mae, id_aluno, nome_do_aluno, sexo, data_de_nascimento, nome_do_pai, nome_da_mae, naturalidade, endereco, serie, nome_do_responsavel, data_mat, novato, admitido, unidade_admitido, ano_anterior, serie_ant, resultado_anterior, numero_aluno, turma) {
		...
		var xml_turma_atual = TR (TD (DIV (STRONG (l_o_aluno, 'não está em turma alguma!', __kwargtrans__ ({_style: 'color: red;'})), __kwargtrans__ ({_class: 'label_e_campo'})), __kwargtrans__ ({_colspan: 2, _class: 'label_e_campo_wrapper'})));
		if (turma !== null) {
