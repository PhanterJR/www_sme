        ...
        if self.posicao <= len(self.turmas):
            window.PhanterPWA.GET(
                ...
                onComplete=lambda data, ajax_status: (
                    self.criar_estatisticas(id_turma, data, ajax_status),
                    self._get_estatistica_registro_de_atividades(self.turmas[self.posicao].id) if self.turmas[self.posicao] is not js_undefined else ""
