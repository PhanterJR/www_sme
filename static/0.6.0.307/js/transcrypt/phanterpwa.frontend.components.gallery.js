// Transcrypt'ed from Python, 2022-04-05 08:18:16
...
export var GalleryInput =  __class__ ('GalleryInput', [object], {
	...
	get simpleView () {return __get__ (this, function (self, url) {
		...
		var html_simple_view = DIV (xml_icons_view, __kwargtrans__ ({_id: 'phanterpwa-gallery-upload-image-simple-view-' + namespace, _class: 'phanterpwa-gallery-upload-image-simple-view', _alt: img_name, _style: "width: {0}px; height: {1}px; background-image: url('{2}'); {3}".format (width, height, url, 'background-position: center; overflow: hidden;')}));
