...
export var ProcurarAluno =  __class__ ('ProcurarAluno', [helpers.XmlConstructor], {
	...
	get initial_xml () {return __get__ (this, function (self) {
		...
		var html = DIV (DIV (DIV (DIV (DIV (H2 ('DIGITE O NOME COMPLETO DO(A) ALUNO(A)'), DIV (widgets.Input ('search_matriculas', __kwargtrans__ ({label: 'Nome do aluno completo', placeholder: 'Nome do aluno completo', icon: I (__kwargtrans__ ({_class: 'fab fa-sistrix'})), icon_on_click: (function __lambda__ () {
			if (arguments.length) {
				var __ilastarg0__ = arguments.length - 1;
				if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
					var __allkwargs0__ = arguments [__ilastarg0__--];
	...
	get binds () {return __get__ (this, function (self) {
		...
		if (ano_letivo !== null && ano_letivo !== undefined && str (ano_letivo).isdigit ()) {
	...
	get _pre_clicagem () {return __get__ (this, function (self, el, ano_letivo) {
		...
		var aluno = window.PhanterPWA.get_widget ('search_matriculas').value ();
		var params = '';
		if (aluno != '') {
