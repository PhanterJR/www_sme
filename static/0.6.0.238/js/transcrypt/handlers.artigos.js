// Transcrypt'ed from Python, 2022-01-19 13:43:13
		...
		if (ajax_status == 'success') {
			...
			if (json.data !== undefined && json.data !== null) {
				...
				for (var x of json.data) {
					...
					var result = md.render (x.texto);
					html_artigos.append (DIV (H2 (x.titulo), DIV (DIV ('Autor:', x.autor, __kwargtrans__ ({_class: 'p-col w1p50'})), DIV ('Postagem:', data_postagem, __kwargtrans__ ({_class: 'p-col w1p50'})), __kwargtrans__ ({_class: 'p-row'})), XML (result), __kwargtrans__ ({_id: 'artigo-container-{0}'.format (x.id), _class: 'artigo-container'})));
				}
