                    ...
                    for y in x.boletin:
                        ...
                        for c in y:
                            if c[1]["tipo"] == "cabecalho":
                                ...
                                if c[0] == "TRANSFERIDO(A)" and not eh_transferido:
                                    eh_transferido = True
                                    linha.append(TD(c[0], _colspan=len(y), **dict(c[1])))
                                elif c[0] == "DESISTENTE" and not eh_desistente:
                                    eh_desistente = True
                                    linha.append(TD(c[0], _colspan=len(y), **dict(c[1])))
                                elif c[0] == "DESISTENTE" or c[0] == "TRANSFERIDO(A)":
                                    pass
                                else:
