...
export var RegistroDeAtividades =  __class__ ('RegistroDeAtividades', [gatehandler.Handler], {
	...
	get initialize () {return __get__ (this, decorators.check_authorization ((function __lambda__ () {
		...
		if (window.PhanterPWA.Request.get_param ('retornar') === null) {
			var BackButton1 = left_bar.LeftBarButton ('back_estatistica_registro_de_atividades', 'Voltar', I (__kwargtrans__ ({_class: 'fas fa-arrow-circle-left'})), __kwargtrans__ (dict ({'tag': 'a', '_href': window.PhanterPWA.XWAY ('registro-de-atividades', arg0, arg1, arg2, arg4), 'position': 'top', 'show_if_way_match': '^estatistica-registro-de-atividades\\/[0-9]{1,}\\/[0-9]{1,}\\/[0-9]{1,}\\/[0-9]{1,}.*$'})));
		}
		else {
			var BackButton1 = left_bar.LeftBarButton ('back_estatistica_registro_de_atividades', 'Voltar', I (__kwargtrans__ ({_class: 'fas fa-arrow-circle-left'})), __kwargtrans__ (dict ({'tag': 'a', '_href': window.PhanterPWA.Request.get_param ('retornar'), 'position': 'top', 'show_if_way_match': '^estatistica-registro-de-atividades\\/[0-9]{1,}\\/[0-9]{1,}\\/[0-9]{1,}\\/[0-9]{1,}.*$'})));
		}
		window.PhanterPWA.Components ['left_bar'].add_button (BackButton1);
	}));},
	...
	get diario_binds () {return __get__ (this, function (self) {
		...
		$ ('.tabela_coluna_modal').off ('click.tabela_coluna_modal').on ('click.tabela_coluna_modal', (function __lambda__ () {
			...
			return self.modal_registro_de_atividades_por_dia (this);
		}));
	});},
	get abrir_diario () {return __get__ (this, function (self, url) {
		if (arguments.length) {
	...
	get modal_confirmar_registro_de_atividades () {return __get__ (this, function (self, el) {
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
			if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
				var __allkwargs0__ = arguments [__ilastarg0__--];
		...
		var atividade = false;
		var nome_aluno = self.data_registro_de_atividades [int (id_matricula)] ['nome'];
		var status = self.data_registro_de_atividades [int (id_matricula)] ['atividades'] [data];
		if (status == 'NF') {
			var complement = ' Atividade';
			var atividade = true;
			var content = DIV (P (STRONG ('O(A) presente aluno(a) fez a atividade proposta?')), P ('No registro consta que o(a) aluno(a) não fez a atividade em ', STRONG (data_ext), '. Se o(a) aluno(a) fez completamente ou de forma satisfatória, ', ' mude para ', STRONG ('FEZ', __kwargtrans__ ({_style: 'color: green'})), '. Caso tenha feito a atividade parcialmente, você pode mudar para ', STRONG ('FEZ PARCIALMENTE', __kwargtrans__ ({_style: 'color: #d28a06'})), '.'), __kwargtrans__ ({_class: 'p-row'}));
		...
		var footer = DIV ((status != 'F' ? forms.FormButton ('confirmar_atividade_fez', 'Fez', __kwargtrans__ ({_class: 'btn-autoresize wave_on_click waves-phanterpwa'})) : ''), (status != 'FP' ? forms.FormButton ('confirmar_atividade_fez_parcialmente', 'Fez parcialmente', __kwargtrans__ ({_class: 'btn-autoresize wave_on_click waves-phanterpwa'})) : ''), (status != 'NF' ? forms.FormButton ('confirmar_atividade_nao_fez', 'Não fez', __kwargtrans__ ({_class: 'btn-autoresize wave_on_click waves-phanterpwa'})) : ''), (atividade ? forms.FormButton ('apagar', 'Apagar', __kwargtrans__ ({_class: 'btn-autoresize wave_on_click waves-phanterpwa'})) : ''), forms.FormButton ('cancelar', 'Cancelar', __kwargtrans__ ({_class: 'btn-autoresize wave_on_click waves-phanterpwa'})), __kwargtrans__ ({_class: 'phanterpwa-form-buttons-container'}));
		self.modal_registro_de_atividades = modal.Modal ('#modal_registro_de_atividades_container', __kwargtrans__ (dict ({'title': nome_aluno, 'content': content, 'footer': footer, 'form': 'registro_de_atividades'})));
		self.modal_registro_de_atividades.open ();
		$ ('#phanterpwa-widget-form-form_button-confirmar_atividade_nao_fez').off ('click.adicionar_registro_de_atividades_fez_parcialmente').on ('click.adicionar_registro_de_atividades_fez_parcialmente', (function __lambda__ () {
			if (arguments.length) {
				var __ilastarg0__ = arguments.length - 1;
				if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
					var __allkwargs0__ = arguments [__ilastarg0__--];
			...
			return self._on_click_registro_de_atividades (id_matricula, id_disciplina, 'Não fez a atividade', data);
		}));
		$ ('#phanterpwa-widget-form-form_button-confirmar_atividade_fez').off ('click.adicionar_registro_de_atividades_fez').on ('click.adicionar_registro_de_atividades_fez', (function __lambda__ () {
			if (arguments.length) {
				var __ilastarg0__ = arguments.length - 1;
				if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
					var __allkwargs0__ = arguments [__ilastarg0__--];
			...
			return self._on_click_registro_de_atividades (id_matricula, id_disciplina, 'Fez toda a atividade', data);
		}));
		$ ('#phanterpwa-widget-form-form_button-confirmar_atividade_fez_parcialmente').off ('click.adicionar_registro_de_atividades_nao_fez').on ('click.adicionar_registro_de_atividades_nao_fez', (function __lambda__ () {
			if (arguments.length) {
				var __ilastarg0__ = arguments.length - 1;
				if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
					var __allkwargs0__ = arguments [__ilastarg0__--];
			...
			return self._on_click_registro_de_atividades (id_matricula, id_disciplina, 'Fez parcialmente a atividade', data);
		}));
		$ ('#phanterpwa-widget-form-form_button-apagar').off ('click.adicionar_registro_de_atividades_nao').on ('click.adicionar_registro_de_atividades_nao', (function __lambda__ () {
			if (arguments.length) {
				var __ilastarg0__ = arguments.length - 1;
				if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
					var __allkwargs0__ = arguments [__ilastarg0__--];
			...
			return self._on_click_registro_de_atividades (id_matricula, id_disciplina, 'Apagar', data);
		}));
		$ ('#phanterpwa-widget-form-form_button-cancelar').off ('click.adicionar_registro_de_atividades_nao').on ('click.adicionar_registro_de_atividades_nao', (function __lambda__ () {
			if (arguments.length) {
				var __ilastarg0__ = arguments.length - 1;
				if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
					var __allkwargs0__ = arguments [__ilastarg0__--];
			...
			return self.modal_registro_de_atividades.close ();
		}));
	});},
	get _on_click_registro_de_atividades () {return __get__ (this, function (self, id_matricula, id_disciplina, novo_status, data) {
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
			if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
				var __allkwargs0__ = arguments [__ilastarg0__--];
		...
		formdata.append ('status', novo_status);
		if (self.id_disciplina !== null && self.id_disciplina !== undefined) {
			window.PhanterPWA.PUT ('api', 'registro-de-atividades', self.id_escola, self.ano_letivo, id_matricula, id_disciplina, __kwargtrans__ ({form_data: formdata, onComplete: (function __lambda__ (data, ajax_status) {
				if (arguments.length) {
					var __ilastarg0__ = arguments.length - 1;
					if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
						var __allkwargs0__ = arguments [__ilastarg0__--];
			...
			window.PhanterPWA.PUT ('api', 'registro-de-atividades', self.id_escola, self.ano_letivo, id_matricula, __kwargtrans__ ({form_data: formdata, onComplete: (function __lambda__ (data, ajax_status) {
				if (arguments.length) {
					var __ilastarg0__ = arguments.length - 1;
					if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
						var __allkwargs0__ = arguments [__ilastarg0__--];
	...
	get depois_de_enviar_registro () {return __get__ (this, function (self, data, ajax_status) {
		...
		if (ajax_status == 'success') {
			...
			if (up !== null && up !== undefined) {
				...
				if (up [1] == 'Fez parcialmente a atividade') {
					$ ('#{0}'.format (up [0])).html (I (__kwargtrans__ ({_class: 'fas fa-check-circle', _style: 'color:#d28a06;'})).jquery ());
					self.data_registro_de_atividades [int (id_matricula)] ['atividades'] [str (data).py_replace ('_', '-')] = 'FP';
				}
				else if (up [1] == 'Não fez a atividade') {
					$ ('#{0}'.format (up [0])).html (I (__kwargtrans__ ({_class: 'fas fa-check-circle', _style: 'color:red;'})).jquery ());
					self.data_registro_de_atividades [int (id_matricula)] ['atividades'] [str (data).py_replace ('_', '-')] = 'NF';
				}
				else if (up [1] == 'Fez toda a atividade') {
					$ ('#{0}'.format (up [0])).html (I (__kwargtrans__ ({_class: 'fas fa-check-circle', _style: 'color:green;'})).jquery ());
					self.data_registro_de_atividades [int (id_matricula)] ['atividades'] [str (data).py_replace ('_', '-')] = 'F';
				}
				else {
					$ ('#{0}'.format (up [0])).html (DIV (up [2], __kwargtrans__ ({_class: 'apagadinho'})).jquery ());
					delete self.data_registro_de_atividades [int (id_matricula)] ['atividades'] [str (data).py_replace ('_', '-')];
				}
			}
			self.diario_binds ();
		}
	});},
	get modal_registro_de_atividades_por_dia () {return __get__ (this, function (self, el) {
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
			if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
				var __allkwargs0__ = arguments [__ilastarg0__--];
		...
		var mes_ext = self.meses [mes];
		var data_ext = '{0} de {1} de {2}'.format (_dia, mes_ext, ano);
		var tabela = TABLE (TR (TH ('Nº', __kwargtrans__ ({_class: 'rotulo', _rowspan: 2})), TH ('NOME ALUNO(A)', __kwargtrans__ ({_class: 'rotulo cabecalho_aluno', _rowspan: 2})), TH ('OPÇÕES', __kwargtrans__ ({_class: 'rotulo', _colspan: 3})), TH ('A', __kwargtrans__ ({_title: 'Apagar', _class: 'rotulo', _rowspan: 2}))), TR (TH ('F', __kwargtrans__ ({_title: 'Fez', _class: 'rotulo'})), TH ('FP', __kwargtrans__ ({_title: 'Fez Parcialmente', _class: 'rotulo'})), TH ('NF', __kwargtrans__ ({_title: 'Não Fez', _class: 'rotulo'}))), __kwargtrans__ ({_class: 'tabela_modal_registro_de_atividades'}));
		self.data_temp = dict ({});
		for (var v of self.data_registro_de_atividades_keys) {
			var x = self.data_registro_de_atividades [v];
			self.data_temp [v] = [v, dia_mes_e_ano];
			var linha = TR (TH (x.numero, __kwargtrans__ ({_rowspan: x.tot_disciplinas})), TH (x.nome, __kwargtrans__ ({_rowspan: x.tot_disciplinas})));
			var body = TBODY (linha, __kwargtrans__ ({_class: 'tbody_registro_de_atividades'}));
			var proximas_linhas = [];
			var cont = 0;
			var _class_f = '';
			var _class_fp = '';
			...
			linha.append (TD (I (__kwargtrans__ ({_class: 'fas fa-check-circle'})), __kwargtrans__ (__mergekwargtrans__ ({_class: 'modal_registro_de_atividades modal_registro_de_atividades{0} modal_registro_de_atividades{1} valorf'.format (x.id, _class_f), _id: '{0}-{1}-f'.format (str (dia_mes_e_ano).py_replace ('-', '_'), x.id)}, dict ({'_data-id_matricula': x.id, '_data-dia_mes_e_ano': dia_mes_e_ano, '_data-valor': 'F'})))));
			linha.append (TD (I (__kwargtrans__ ({_class: 'fas fa-check-circle'})), __kwargtrans__ (__mergekwargtrans__ ({_class: 'modal_registro_de_atividades modal_registro_de_atividades{0} modal_registro_de_atividades{1} valorfp'.format (x.id, _class_fp), _id: '{0}-{1}-fp'.format (str (dia_mes_e_ano).py_replace ('-', '_'), x.id)}, dict ({'_data-id_matricula': x.id, '_data-dia_mes_e_ano': dia_mes_e_ano, '_data-valor': 'FP'})))));
			linha.append (TD (I (__kwargtrans__ ({_class: 'fas fa-check-circle'})), __kwargtrans__ (__mergekwargtrans__ ({_class: 'modal_registro_de_atividades modal_registro_de_atividades{0} modal_registro_de_atividades{1} valornf'.format (x.id, _class_nf), _id: '{0}-{1}-nf'.format (str (dia_mes_e_ano).py_replace ('-', '_'), x.id)}, dict ({'_data-id_matricula': x.id, '_data-dia_mes_e_ano': dia_mes_e_ano, '_data-valor': 'NF'})))));
			linha.append (TD (I (__kwargtrans__ ({_class: 'fas fa-eraser'})), __kwargtrans__ (__mergekwargtrans__ ({_class: 'modal_registro_de_atividades modal_registro_de_atividades{0} modal_registro_de_atividades{1} valora'.format (x.id, _class_a), _id: '{0}-{1}-nf'.format (str (dia_mes_e_ano).py_replace ('-', '_'), x.id)}, dict ({'_data-id_matricula': x.id, '_data-dia_mes_e_ano': dia_mes_e_ano, '_data-valor': 'A'})))));
			tabela.append (body);
		}
		var titulo_modal = 'Atividades do dia {0}'.format (data_ext);
		var footer = DIV (forms.FormButton ('confirmar_atividades', 'Salvar Alterações', __kwargtrans__ ({_class: 'btn-autoresize wave_on_click waves-phanterpwa'})), __kwargtrans__ ({_class: 'phanterpwa-form-buttons-container'}));
		self.modal_dia_registro_de_atividades = modal.Modal ('#modal_dia_registro_de_atividades_container', __kwargtrans__ (dict ({'title': titulo_modal, 'content': tabela, 'footer': footer})));
	...
	get diario_modal_binds () {return __get__ (this, function (self) {
		...
		$ ('.modal_registro_de_atividades').off ('click.mod_contr').on ('click.mod_contr', (function __lambda__ () {
			if (arguments.length) {
				var __ilastarg0__ = arguments.length - 1;
				if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
					var __allkwargs0__ = arguments [__ilastarg0__--];
	...
	get add_opcoes () {return __get__ (this, function (self, el) {
		...
		if (element.hasClass ('ativado')) {
			if (!(element.hasClass ('valora'))) {
				...
				$ ('.modal_registro_de_atividades{0}.valora'.format (id_matricula)).addClass ('ativado');
			}
		}
		else {
			if (valor == 'A') {
			...
			$ ('.modal_registro_de_atividades{0}'.format (id_matricula)).removeClass ('ativado');
			element.addClass ('ativado');
			if (__in__ (id_matricula, self.data_temp.py_keys ())) {
				self.data_temp [id_matricula] [2] = valor;
			}
	...
	get confirmar_modal_atividades () {return __get__ (this, function (self) {
		...
		if (self.id_disciplina !== null && self.id_disciplina !== undefined) {
			window.PhanterPWA.PUT ('api', 'registro-de-atividades', self.id_escola, self.ano_letivo, self.id_turma, 'atividades', self.id_disciplina, __kwargtrans__ ({form_data: formdata, onComplete: (function __lambda__ (data, ajax_status) {
				if (arguments.length) {
					var __ilastarg0__ = arguments.length - 1;
					if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
						var __allkwargs0__ = arguments [__ilastarg0__--];
			...
			window.PhanterPWA.PUT ('api', 'registro-de-atividades', self.id_escola, self.ano_letivo, 'atividades', __kwargtrans__ ({form_data: formdata, onComplete: (function __lambda__ (data, ajax_status) {
				if (arguments.length) {
					var __ilastarg0__ = arguments.length - 1;
					if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
						var __allkwargs0__ = arguments [__ilastarg0__--];
			...
			if (atividades !== null && atividades !== undefined) {
				for (var up of atividades) {
					...
					if (up [2] == 'FP') {
						...
						$ ('#{0}'.format (element_id)).html (DIV (str (data).__getslice__ (-(2), null, 1), __kwargtrans__ ({_class: 'apagadinho'})).jquery ());
						delete self.data_registro_de_atividades [int (id_matricula)] ['atividades'] [str (data)];
					}
				}
				self.diario_binds ();
			}
