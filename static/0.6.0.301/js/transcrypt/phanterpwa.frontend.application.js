// Transcrypt'ed from Python, 2022-04-05 08:17:53
...
export var PhanterPWA =  __class__ ('PhanterPWA', [object], {
	...
	get __init__ () {return __get__ (this, function (self, config, gates) {
		...
		self._after_login = parameters.py_get ('after_login', null);
		self._after_logout = parameters.py_get ('after_logout', null);
		self._send_global_error = parameters.py_get ('send_global_error', false);
		self.counter = 0;
		self.states = dict ();
		...
		var test_bool = 'serviceWorker' in navigator
		if (test_bool) {
			caches.keys ().then ((function __lambda__ (names) {
				if (arguments.length) {
					var __ilastarg0__ = arguments.length - 1;
					if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
						var __allkwargs0__ = arguments [__ilastarg0__--];
						for (var __attrib0__ in __allkwargs0__) {
							switch (__attrib0__) {
								case 'names': var names = __allkwargs0__ [__attrib0__]; break;
							}
						}
					}
				}
				...
				return self._clear_cache (names);
			}));
			navigator.serviceWorker.register ('/sw.js', dict ({'scope': '/'})).then ((function __lambda__ (reg) {
				if (arguments.length) {
					var __ilastarg0__ = arguments.length - 1;
					if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
						var __allkwargs0__ = arguments [__ilastarg0__--];
						for (var __attrib0__ in __allkwargs0__) {
							switch (__attrib0__) {
								case 'reg': var reg = __allkwargs0__ [__attrib0__]; break;
							}
						}
					}
				}
				...
				return self._swregister (reg, 'register');
				...
				return console.error ('Registration failed with {0}'.format (error));
			}));
		}
	...
	get _clear_cache () {return __get__ (this, function (self, names) {
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
			if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
				var __allkwargs0__ = arguments [__ilastarg0__--];
	...
	get _swregister () {return __get__ (this, function (self, reg) {
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
			if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
				var __allkwargs0__ = arguments [__ilastarg0__--];
	...
	get onGlobalError () {return __get__ (this, function (self, message, source, lineno, colno, error) {
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
			if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
				var __allkwargs0__ = arguments [__ilastarg0__--];
				for (var __attrib0__ in __allkwargs0__) {
					switch (__attrib0__) {
						...
						case 'colno': var colno = __allkwargs0__ [__attrib0__]; break;
						case 'error': var error = __allkwargs0__ [__attrib0__]; break;
					}
				}
			}
		...
		if (self._send_global_error && self.ApiServer !== undefined) {
			...
			self.POST ('api', 'error', __kwargtrans__ ({form_data: formdata}));
		}
	});},
	...
	get get_widget () {return __get__ (this, function (self, widget_identifier) {
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
			if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
				var __allkwargs0__ = arguments [__ilastarg0__--];
				for (var __attrib0__ in __allkwargs0__) {
					switch (__attrib0__) {
						case 'self': var self = __allkwargs0__ [__attrib0__]; break;
						case 'widget_identifier': var widget_identifier = __allkwargs0__ [__attrib0__]; break;
					}
				}
			}
		}
		...
		return self.Request.widgets.py_get (widget_identifier, null);
	});},
	...
	get _xway () {return __get__ (this, function (self) {
		var kargs = dict ();
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
			if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
		...
		var all_args = self.ApiServer._process_args (args);
		var url_vars = self.ApiServer._process_parameters (kargs);
		var all_vars = self.ApiServer._serialize_vars (url_vars);
		var current_uri = '{0}{1}'.format (all_args, all_vars);
		return current_uri;
	});},
	get XWAY () {return __get__ (this, function (self) {
		var kargs = dict ();
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
			if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
		...
		var current_uri = '/#_phanterpwa:/{0}'.format (self._xway (...args, __kwargtrans__ (kargs)));
		return current_uri;
	});},
	get relative_way () {return __get__ (this, function (self) {
		var kargs = dict ();
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
			if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
		...
		return self._xway (...args, __kwargtrans__ (kargs));
	});},
	...
	get remove_last_auth_user () {return function () {
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
			if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
				var __allkwargs0__ = arguments [__ilastarg0__--];
	...
	get reload_auth_user () {return __get__ (this, function () {
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
			if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
				var __allkwargs0__ = arguments [__ilastarg0__--];
	...
	get _after_submit_login () {return __get__ (this, function (self, data, ajax_status, callback) {
		...
		if (self.DEBUG) {
			if (json.i18n !== undefined && json.i18n !== null) {
	...
	get _after_oauth () {return __get__ (this, function (self, data, ajax_status, callback) {
		if (typeof callback == 'undefined' || (callback != null && callback.hasOwnProperty ("__kwargtrans__"))) {;
			var callback = null;
		};
		if (arguments.length) {
	...
	get login () {return __get__ (this, function (self, csrf_token, username, password, remember_me) {
		...
		var user_mobile_number = parameters.py_get ('user_mobile_number', false);
	...
	get oauth () {return __get__ (this, function (self, social_name, state) {
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
			if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
				var __allkwargs0__ = arguments [__ilastarg0__--];
		...
		window.PhanterPWA.POST ('api', 'oauth', 'prompt', social_name, __kwargtrans__ ({form_data: formdata, onComplete: self._after_oauth}));
	});},
	...
	get register () {return __get__ (this, function (self, csrf_token, first_name, last_name, email, password, password_repeat) {
		...
		if (parameters.py_get ('user_mobile_number', false)) {
	...
	get logout () {return __get__ (this, function (self) {
		...
		var AuthUser = self.Components ['auth_user'];
		if (AuthUser !== null && AuthUser !== undefined) {
			AuthUser.start ();
		}
		var LeftBar = self.Components ['left_bar'];
	...
	get get_consolided_way () {return function () {
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
			if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
				var __allkwargs0__ = arguments [__ilastarg0__--];
	...
	get get_current_way () {return __get__ (this, function (self) {
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
			if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
				var __allkwargs0__ = arguments [__ilastarg0__--];
		...
		var current_way = self._get_way_from_url_hash ();
		if (current_way === null || current_way === undefined || current_way === 'lock') {
			var current_way = 'home';
		}
		return current_way;
	});},
	get get_current_gate () {return function () {
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
			if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
				var __allkwargs0__ = arguments [__ilastarg0__--];
		...
		return str (window.PhanterPWA.get_current_way ()).py_split ('/') [0];
	};},
	get open_code_way () {return function (code, request, response, reasons) {
		...
		if (typeof reasons == 'undefined' || (reasons != null && reasons.hasOwnProperty ("__kwargtrans__"))) {;
			var reasons = null;
		};
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
			if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
				...
				for (var __attrib0__ in __allkwargs0__) {
					switch (__attrib0__) {
						...
						case 'reasons': var reasons = __allkwargs0__ [__attrib0__]; break;
					}
				}
			}
		}
	...
	get get_auth_user () {return function () {
		...
		if (auth_user !== null && auth_user !== undefined) {
			var parsed_user = JSON.parse (auth_user);
	...
	get store_auth_user () {return __get__ (this, function (self, auth_user) {
		if (typeof auth_user == 'undefined' || (auth_user != null && auth_user.hasOwnProperty ("__kwargtrans__"))) {;
			var auth_user = null;
		};
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
	...
	get update_auth_user () {return __get__ (this, function (self, callback) {
		if (typeof callback == 'undefined' || (callback != null && callback.hasOwnProperty ("__kwargtrans__"))) {;
			var callback = null;
		};
		if (arguments.length) {
		...
		window.PhanterPWA.GET (__kwargtrans__ (dict ({'url_args': ['api', 'auth'], 'onComplete': (function __lambda__ (data, ajax_status) {
			if (arguments.length) {
				var __ilastarg0__ = arguments.length - 1;
				if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
					var __allkwargs0__ = arguments [__ilastarg0__--];
			...
			return self._after_get_auth_user (data, ajax_status, callback);
		})})));
	});},
	get _after_get_auth_user () {return __get__ (this, function (self, data, ajax_status, callback) {
		if (typeof callback == 'undefined' || (callback != null && callback.hasOwnProperty ("__kwargtrans__"))) {;
			var callback = null;
		};
		if (arguments.length) {
	...
	get set_last_auth_user () {return function (auth_user) {
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
			if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
				var __allkwargs0__ = arguments [__ilastarg0__--];
	...
	get get_auth_user_image () {return function () {
		...
		var image_user = '/static/{0}/images/user.png'.format (window.PhanterPWA.VERSIONING);
		var auth_user = window.PhanterPWA.get_auth_user ();
	...
	get get_last_auth_user () {return function () {
		...
		if (last_auth_user !== null && last_auth_user !== undefined) {
			var parsed_last_auth_user = JSON.parse (last_auth_user);
	...
	get open_xway () {return __get__ (this, function (self) {
		var kargs = dict ();
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
			if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
		...
		self.open_way (self._xway (...args, __kwargtrans__ (kargs)));
	});},
	get open_way () {return __get__ (this, function (self, way) {
		...
		else if (way == '' || way === null || way === undefined) {
	...
	get set_push_way () {return __get__ (this, function (self, way) {
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
			if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
				var __allkwargs0__ = arguments [__ilastarg0__--];
	...
	get GET () {return __get__ (this, function (self) {
		...
		self.ApiServer.GET (...args, __kwargtrans__ (parameters));
	});},
	get DELETE () {return __get__ (this, function (self) {
		...
		self.ApiServer.DELETE (...args, __kwargtrans__ (parameters));
	});},
	get POST () {return __get__ (this, function (self) {
		...
		self.ApiServer.POST (...args, __kwargtrans__ (parameters));
	});},
	get PUT () {return __get__ (this, function (self) {
		...
		self.ApiServer.PUT (...args, __kwargtrans__ (parameters));
	});},
	get LOAD () {return __get__ (this, function (self) {
		...
		Loads (...args, __kwargtrans__ (parameters));
	});}
});
...
export var WayRequest =  __class__ ('WayRequest', [object], {
	...
	get get_param () {return __get__ (this, function (self, k, py_default) {
		...
		if (self.params !== null && self.params !== undefined) {
			return self.params.py_get (k, py_default);
		}
		else {
			return py_default;
		}
	...
	get _open_way () {return __get__ (this, function (self, way) {
		...
		if (__in__ (self.gate, window.PhanterPWA.Gates)) {
			try {
				...
				window.PhanterPWA.onGlobalError (__except0__.message, __except0__.fileName, __except0__.lineNumber, __except0__.columnNumber, __except0__.py_name);
